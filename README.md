...
│   └── distributed/          分布式：goim 式 Comet / Logic / Job + registry
...
| `danmu/distributed` | `github.com/YansIlinta/danmu-distributed` | `comet` `logic` `job` `registry` `chaintest` |
...
| [danmu/distributed/DESIGN.md](./danmu/distributed/DESIGN.md) | goim 式微服务化设计：Comet/Logic/Job 分层与 registry |
