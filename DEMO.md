...
> 技术演进细节见 [EVOLUTION.md](./EVOLUTION.md)；弹幕压测见 [PROJECT.md](./PROJECT.md) / [README.md](./README.md)。
...
|------|------|
| **DEMO.md（本文）** | 演示顺序 |
| [EVOLUTION.md](./EVOLUTION.md) | 点播演进决策与里程碑 |
| [PROJECT.md](./PROJECT.md) | 弹幕系统统合 |
| [deploy/platform/PRODUCTION.md](./deploy/platform/PRODUCTION.md) | 上线清单 |
| [deploy/platform/.env.example](./deploy/platform/.env.example) | 环境变量 |
